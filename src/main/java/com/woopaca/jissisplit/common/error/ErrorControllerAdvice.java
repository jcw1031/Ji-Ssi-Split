...
import com.woopaca.jissisplit.common.ApiResults.ErrorResponse;
import com.woopaca.jissisplit.common.error.exception.BusinessException;
...
public class ErrorControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleBusinessException(BusinessException exception) {
        ...
        return ResponseEntity.status(exception.getErrorHttpStatus())
                .body(errorResponse);
    }
